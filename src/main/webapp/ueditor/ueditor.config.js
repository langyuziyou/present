...
(function () {
     ...
     */
	var href = basePath+"ueditor/";
	window.UEDITOR_HOME_URL=href;
    ...
    var ip = 'http://192.168.16.218/rrc1/';
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:basePath+"b2bgoodsinfo/ueditorUpload"             //图片上传提交地址
       ...
       ,maxImageSideLength:900                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,imageManagerPath:ip                                    //图片修正地址，同imagePath
