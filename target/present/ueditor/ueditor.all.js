    ...
    Popup.prototype = {
        ...
        showAnchorRect: function ( rect, hoz, adj ){
            ...
            if(this.editor){
                ...
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = popEl.style.zIndex - 1+20000;
            }
...
//            }
        ...
        _show: function (){
            if (this._hidden) {
                ...
                this._hidden = false;
                this.fireEvent('show');
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = this.getDom().style.zIndex - 4+20000;
            }
        },
        isHidden: function (){
            return this._hidden;
